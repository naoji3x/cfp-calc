import { type TravelExpenses, type TravelItem } from '../../src/common/types'
import {
  estimateTravelAnnualAmount,
  estimateTravelIntensity
} from '../../src/other/travel'

const expectAmount = (
  param: { travelExpenses: TravelExpenses },
...
describe('travel', () => {
  test('amount case 01', () => {
    expectAmount({ travelExpenses: '10k-less' }, [
  ...
  test('amount case 02', () => {
    expectAmount({ travelExpenses: '10k-30k' }, [
  ...
  test('amount case 03', () => {
    expectAmount({ travelExpenses: '30k-50k' }, [
  ...
  test('amount case 04', () => {
    expectAmount({ travelExpenses: '50k-100k' }, [
  ...
  test('amount case 05', () => {
    expectAmount({ travelExpenses: '100k-200k' }, [
  ...
  test('amount case 06', () => {
    expectAmount({ travelExpenses: '200k-more' }, [
      { item: 'hotel', value: 252.3887612 },
      { item: 'travel', value: 47.61123876 }
    ])
  })
  test('amount case 07', () => {
    expectAmount({ travelExpenses: 'unknown' }, [
