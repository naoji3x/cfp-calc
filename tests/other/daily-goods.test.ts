...
} from '../../src/other/daily-goods'

const expectAmount = (
  param: { dailyGoodsExpenses: DailyGoodsExpenses; residentCount: number },
...
describe('daily-goods', () => {
  test('amount case 01', () => {
    expectAmount({ dailyGoodsExpenses: '5k-less', residentCount: 1 }, [
  ...
  test('amount case 02', () => {
    expectAmount({ dailyGoodsExpenses: '5k-10k', residentCount: 1 }, [
  ...
  test('amount case 03', () => {
    expectAmount({ dailyGoodsExpenses: '10k-20k', residentCount: 1 }, [
  ...
  test('amount case 04', () => {
    expectAmount({ dailyGoodsExpenses: '20k-30k', residentCount: 1 }, [
  ...
  test('amount case 05', () => {
    expectAmount({ dailyGoodsExpenses: '30k-more', residentCount: 1 }, [
  ...
  test('amount case 06', () => {
    expectAmount({ dailyGoodsExpenses: 'unknown', residentCount: 1 }, [
  ...
  test('amount case 08', () => {
    expectAmount({ dailyGoodsExpenses: 'unknown', residentCount: 3 }, [
      { item: 'sanitation', value: 31.8821673 },
      { item: 'kitchen-goods', value: 8.638990484 },
      { item: 'paper-stationery', value: 2.621777546 }
    ])
  ...
  test('amount case 09', () => {
    expectAmount({ dailyGoodsExpenses: '5k-less', residentCount: 3 }, [
