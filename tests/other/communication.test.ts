...
describe('communication', () => {
  test('amount case 01', () => {
    expectAmount({ communicationExpenses: '5k-less', residentCount: 1 }, [
  ...
  test('amount case 02', () => {
    expectAmount({ communicationExpenses: '5k-10k', residentCount: 1 }, [
  ...
  test('amount case 03', () => {
    expectAmount({ communicationExpenses: '10k-20k', residentCount: 1 }, [
  ...
  test('amount case 04', () => {
    expectAmount({ communicationExpenses: '20k-30k', residentCount: 1 }, [
  ...
  test('amount case 05', () => {
    expectAmount({ communicationExpenses: '30k-more', residentCount: 1 }, [
  ...
  test('amount case 06', () => {
    expectAmount({ communicationExpenses: 'unknown', residentCount: 1 }, [
  ...
  test('amount case 08', () => {
    expectAmount({ communicationExpenses: 'unknown', residentCount: 3 }, [
      { item: 'communication', value: 130.4760614 },
      { item: 'broadcasting', value: 17.52298123 }
    ])
  })
  ...
  test('amount case 09', () => {
    expectAmount({ communicationExpenses: '5k-less', residentCount: 3 }, [
